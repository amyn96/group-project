...
getName.pack(side=tk.LEFT)
connectBtn = tk.Button(welcomeTopFrame, text="Connect", command=lambda : connect())
connectBtn.pack(side=tk.LEFT)
welcomeTopFrame.pack(side=tk.TOP)

MsgTopFrame = tk.Frame(win)
lineLabel = tk.Label(MsgTopFrame, text="________________________________________________________").pack()
...
lbl_opponent_choice = tk.Label(GameRoundFrame, text="OPPONNENT MOVES: " + "None")
...
# BUTTONS PART 2
btn_rock = tk.Button(btnFrame, text="Rock", command=lambda : choice("rock"), state=tk.DISABLED, image=photo_rock)
btn_paper = tk.Button(btnFrame, text="Paper", command=lambda : choice("paper"), state=tk.DISABLED, image=photo_paper)
btn_scissors = tk.Button(btnFrame, text="Scissors", command=lambda : choice("scissors"), state=tk.DISABLED, image=photo_scissors)
...
def choice(arg):
    ...
    playerMoves = arg
    lbl_your_choice["text"] = "Your choice: " + playerMoves
...
def receive_message_from_server(sck, m):
    ...
    while True:
        ...
        if fromS.startswith("welcome"):
            ...
            opponentMoves = fromS.replace("$opponent", "")
            ...
            lbl_opponent_choice["text"] = "Opponent choice: " + opponentMoves
