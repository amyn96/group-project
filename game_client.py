...
# MAIN WINDOW
top_welcome_frame= tk.Frame(win)
...
top_message_frame = tk.Frame(win)
...
lbl_welcome.pack()
lbl_line_server = tk.Label(top_message_frame, text="_______________________________________________________")
lbl_line_server.pack_forget()
top_message_frame.pack(side=tk.TOP)

# PLAYER'S NAME SECTION
top_frame = tk.Frame(win)
top_left_frame = tk.Frame(top_frame, highlightbackground="red", highlightcolor="red", highlightthickness=1)
...
# TIMER SECTIONS
top_right_frame = tk.Frame(top_frame, highlightbackground="red", highlightcolor="red", highlightthickness=1)
lbl_game_round = tk.Label(top_right_frame, text="ROUND (x) GAME WILL START IN ", foreground="green", font = "Helvetica 14 bold")
...
lbl_line = tk.Label(middle_frame, text="___________________________________________________________").pack()
lbl_line = tk.Label(middle_frame, text="**** PLAYERS MOVES ****", font = "Helvetica 13 bold", foreground="blue").pack()
lbl_line = tk.Label(middle_frame, text="___________________________________________________________").pack()

round_frame = tk.Frame(middle_frame)
lbl_round = tk.Label(round_frame, text="Round")
lbl_round.pack()
lbl_your_choice = tk.Label(round_frame, text="MOVES: " + "None", font = "Helvetica 13 bold")
lbl_your_choice.pack()
lbl_opponent_choice = tk.Label(round_frame, text="OPPONNENT MOVES: " + "None")
...
lbl_line = tk.Label(final_frame, text="___________________________________________________________").pack()
lbl_final_result = tk.Label(final_frame, text=" ", font = "Helvetica 13 bold", foreground="blue")
lbl_final_result.pack()
lbl_line = tk.Label(final_frame, text="____________________________________________________________").pack()
