...
def send_receive_client_message(client_connection, client_ip_addr):
    ...
    if len(clients) > 1:
        ...
        # SEND OPPONENT NAME
        op1 = "opponent_name$" + str(clients_names[1].decode())
        op2 = "opponent_name$" + str(clients_names[0].decode())
    ...
    while True:
        ...
        if len(player_data) == 2:
            ...
            op1c = "$opponent_choice" + str(player_data[1].get("choice").decode())
            op2c = "$opponent_choice" + str(player_data[0].get("choice").decode())
            print(op1c)
            print(op2c)
